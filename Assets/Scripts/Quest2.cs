...
public class Quest2 : MonoBehaviour
{
    ...
    private void Awake()
    {
        ...
        Debug.Log("Quest2 was added!");
    }
    public void CompleteQuest()
    {
        //if the quest is done, change the text
        Debug.Log("Quest2 was completed!");
    ...
    {
        Debug.Log("Quest2 was interacted with!");
        Invoke("Randomizer", 0);
        panelLines = Mathf.Clamp(panelLines, 0, 5);

        //for testing purposes
        //gameObject.GetComponent<Renderer>().material.color = Random.ColorHSV(0f, 1f, 1f, 1f, 0.5f, 1f);
        Debug.Log("Quest2 - Line amount is: " + panelLines);
        ...
        else
        {
            ...
            {
                textBox.text = "";
                gameObject.AddComponent<Quest3>();
                Destroy(GetComponent<Quest2>());
            }
        }
    }
}
