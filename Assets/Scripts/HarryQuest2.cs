...
public class HarryQuest2 : MonoBehaviour
{
    ...
    private void Awake()
    {
        ...
        var loadTemplateText = Resources.Load<TemplateText>("ScriptableObjects/Quest1");
        var loadCompletionText = Resources.Load<TemplateText>("ScriptableObjects/Quest1Done");
