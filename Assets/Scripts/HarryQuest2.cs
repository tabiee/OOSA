...
public class HarryQuest2 : MonoBehaviour
{
    ...
    private void Awake()
    {
        ...
        var loadTemplateText = Resources.Load<TemplateText>("ScriptableObjects/SirHarry2");
        var loadCompletionText = Resources.Load<TemplateText>("ScriptableObjects/SirHarry2Done");
        ...
        Debug.Log("HarryQuest2 was added!");
    }
    public void CompleteQuest()
    {
        //if the quest is done, change the text
        Debug.Log("HarryQuest2 was completed!");
    ...
    {
        Debug.Log("HarryQuest2 was interacted with!");
        Invoke("Randomizer", 0);
        panelLines = Mathf.Clamp(panelLines, 0, 5);

        //for testing purposes
        //gameObject.GetComponent<Renderer>().material.color = Random.ColorHSV(0f, 1f, 1f, 1f, 0.5f, 1f);
        Debug.Log("HarryQuest2 - Line amount is: " + panelLines);
        ...
        else
        {
            ...
            {
                Debug.Log("HarryQuest2 was accepted!");
                questAccepted = true;
                textBox.text = "";
            ...
            {
                textBox.text = "";
                gameObject.AddComponent<HarryQuest3>();
                Destroy(GetComponent<HarryQuest2>());
            }
        }
    }
}
