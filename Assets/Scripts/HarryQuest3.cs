...
public class HarryQuest3 : MonoBehaviour
{
    ...
    private void Awake()
    {
        ...
        Debug.Log("HarryQuest3 was added!");
    }
    public void CompleteQuest()
    {
        //if the quest is done, change the text
        Debug.Log("HarryQuest3 was completed!");
    ...
    public void Interact()
    {
        ...
        Debug.Log("HarryQuest3 - Line amount is: " + panelLines);
        ...
        else
        {
            ...
            {
                Debug.Log("HarryQuest3 was accepted!");
                questAccepted = true;
                textBox.text = "";
