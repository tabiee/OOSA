...
public class ReggyQuest2 : MonoBehaviour
{
    ...
    private void Awake()
    {
        ...
        var loadCompletionText = Resources.Load<TemplateText>("ScriptableObjects/Reggie2Done");
        ...
        Debug.Log("ReggyQuest2 was added!");
    }
    public void CompleteQuest()
    {
        //if the quest is done, change the text
        Debug.Log("ReggyQuest2 was completed!");
    ...
    {
        Debug.Log("ReggyQuest2 was interacted with!");
        Invoke("Randomizer", 0);
        panelLines = Mathf.Clamp(panelLines, 0, 5);

        //for testing purposes
        //gameObject.GetComponent<Renderer>().material.color = Random.ColorHSV(0f, 1f, 1f, 1f, 0.5f, 1f);
        Debug.Log("ReggyQuest2 - Line amount is: " + panelLines);
        ...
        else
        {
            ...
            {
                Debug.Log("ReggyQuest2 was accepted!");
                questAccepted = true;
                textBox.text = "";
            ...
            {
                textBox.text = "";
                gameObject.AddComponent<ReggyQuest3>();
                Destroy(GetComponent<ReggyQuest2>());
            }
        }
    }
}
