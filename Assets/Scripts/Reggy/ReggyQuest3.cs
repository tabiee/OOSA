...
public class ReggyQuest3 : MonoBehaviour
{
    ...
    private void Awake()
    {
        ...
        var loadTemplateText = Resources.Load<TemplateText>("ScriptableObjects/Reggie3");
        var loadCompletionText = Resources.Load<TemplateText>("ScriptableObjects/Reggie3Done");
        ...
        Debug.Log("ReggyQuest3 was added!");
    }
    public void CompleteQuest()
    {
        //if the quest is done, change the text
        Debug.Log("ReggyQuest3 was completed!");
    ...
    {
        Debug.Log("ReggyQuest3 was interacted with!");
        Invoke("Randomizer", 0);
        panelLines = Mathf.Clamp(panelLines, 0, 5);

        //for testing purposes
        //gameObject.GetComponent<Renderer>().material.color = Random.ColorHSV(0f, 1f, 1f, 1f, 0.5f, 1f);
        Debug.Log("ReggyQuest3 - Line amount is: " + panelLines);
        ...
        else
        {
            ...
            {
                Debug.Log("ReggyQuest3 was accepted!");
                questAccepted = true;
                textBox.text = "";
