...
public class ReggyQuest1 : MonoBehaviour
{
    ...
    private void Awake()
    {
        ...
        var loadTemplateText = Resources.Load<TemplateText>("ScriptableObjects/Reggie1");
        var loadCompletionText = Resources.Load<TemplateText>("ScriptableObjects/Reggie1Done");
        ...
        Debug.Log("ReggyQuest1 was added!");
    }
    public void CompleteQuest()
    {
        //if the quest is done, change the text
        Debug.Log("ReggyQuest1 was completed!");
    ...
    {
        Debug.Log("ReggyQuest1 was interacted with!");
        Invoke("Randomizer", 0);
        panelLines = Mathf.Clamp(panelLines, 0, 5);

        //for testing purposes
        //gameObject.GetComponent<Renderer>().material.color = Random.ColorHSV(0f, 1f, 1f, 1f, 0.5f, 1f);
        Debug.Log("ReggyQuest1 - Line amount is: " + panelLines);
        ...
        else
        {
            ...
            {
                Debug.Log("ReggyQuest1 was accepted!");
                questAccepted = true;
                textBox.text = "";
            ...
            {
                textBox.text = "";
                gameObject.AddComponent<ReggyQuest2>();
                Destroy(GetComponent<ReggyQuest1>());
            }
        }
    }
}
