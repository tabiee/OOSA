...
public class LilithQuest1 : MonoBehaviour
{
    ...
    private void Awake()
    {
        ...
        var loadTemplateText = Resources.Load<TemplateText>("ScriptableObjects/LilShit1");
        var loadCompletionText = Resources.Load<TemplateText>("ScriptableObjects/LilShit1Done");
        ...
        Debug.Log("LilithQuest1 was added!");
    }
    public void CompleteQuest()
    {
        //if the quest is done, change the text
        Debug.Log("LilithQuest1 was completed!");
    ...
    {
        Debug.Log("LilithQuest1 was interacted with!");
        Invoke("Randomizer", 0);
        panelLines = Mathf.Clamp(panelLines, 0, 5);

        //for testing purposes
        //gameObject.GetComponent<Renderer>().material.color = Random.ColorHSV(0f, 1f, 1f, 1f, 0.5f, 1f);
        Debug.Log("LilithQuest1 - Line amount is: " + panelLines);
        ...
        else
        {
            ...
            {
                textBox.text = "";
                gameObject.AddComponent<LilithQuest2>();
                Destroy(GetComponent<LilithQuest1>());
            }
        }
    }
}
